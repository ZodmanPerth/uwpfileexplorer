...
namespace System
{
	...
	public static class NumericExtensions
	{
		...
		public static string AsBytesFriendly(this int number, int decimals = 2)
		{
			return ((double)number).AsBytesFriendly(decimals);
		}

		public static string AsBytesFriendly(this uint number, int decimals = 2)
		{
			return ((double)number).AsBytesFriendly(decimals);
		}

		public static string AsBytesFriendly(this long number, int decimals = 2)
		{
			return ((double)number).AsBytesFriendly(decimals);
		}

		public static string AsBytesFriendly(this ulong number, int decimals = 2)
		{
			return ((double)number).AsBytesFriendly(decimals);
		}
